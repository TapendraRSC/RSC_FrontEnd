        ...
        <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="absolute top-full left-0 z-50 w-full sm:w-80 mt-1 bg-white dark:bg-slate-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-80 overflow-hidden">
                            <div className="p-3 border-b border-gray-200 dark:border-gray-600">
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-400"
                                />
                            </div>
                ...
                <input
                    ...
                    className={`flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-l-none sm:rounded-r-lg sm:border-l-0 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-400 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 transition-all ${error
