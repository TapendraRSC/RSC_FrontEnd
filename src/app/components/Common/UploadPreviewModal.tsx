                ...
                <div className="px-4 py-3 sm:px-6 sm:py-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <p className="font-medium text-gray-900 dark:text-gray-100 text-sm sm:text-base">{fileName}</p>
                                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
                                    {totalRows} rows found
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center gap-1 sm:gap-2 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">
                ...
                <div className="flex-1 overflow-hidden p-4 sm:p-6">
                    ...
                    {previewData.length > 0 ? (
                        ...
                        <div className="text-center py-10 sm:py-12 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <AlertCircle className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400 dark:text-gray-300 mx-auto mb-3 sm:mb-4" />
                            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">No data preview available</p>
                        </div>
                    )}
