...
//     Hash, CreditCard, Download, Ruler, Users
// } from 'lucide-react';
...
//                                                     return (
//                                                         <td key={`booking-${booking.id}-${accessor}`} className="px-2 sm:px-4 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm">
//                                                             <span className={`px-2 py-0.5 rounded-full text-xs ${booking.gender === 'Male' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' : booking.gender === 'Female' ? 'bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400'}`}>
...
//                                                     return (
//                                                         <td key={`booking-${booking.id}-${accessor}`} className="px-2 sm:px-4 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-blue-600 dark:text-blue-400">
//                                                             {formattedBooking.formattedPlotSize}
//                                                         </td>
//                                                     );
//                                                 }
...
//                                                     return (
//                                                         <td key={`booking-${booking.id}-${accessor}`} className="px-2 sm:px-4 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-purple-600 dark:text-purple-400">
//                                                             {formattedBooking.formattedOnlineAmount}
//                                                         </td>
//                                                     );
//                                                 }
...
//                                                             {formattedBooking.formattedCreditAmount}
//                                                         </td>
//                                                     );
//                                                 }
//                                                 if (accessor === 'maintenance') {
//                                                     return (
//                                                         <td key={`booking-${booking.id}-${accessor}`} className="px-2 sm:px-4 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-teal-600 dark:text-teal-400">
//                                                             {formattedBooking.formattedMaintenance}
//                                                         </td>
//                                                     );
//                                                 }
//                                                 if (accessor === 'stampDuty') {
//                                                     return (
//                                                         <td key={`booking-${booking.id}-${accessor}`} className="px-2 sm:px-4 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-amber-600 dark:text-amber-400">
//                                                             {formattedBooking.formattedStampDuty}
//                                                         </td>
//                                                     );
//                                                 }
//                                                 if (accessor === 'legalFees') {
//                                                     return (
//                                                         <td key={`booking-${booking.id}-${accessor}`} className="px-2 sm:px-4 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-rose-600 dark:text-rose-400">
//                                                             {formattedBooking.formattedLegalFees}
//                                                         </td>
//                                                     );
//                                                 }
...
//                                         {/* Project, Plot, Plot Size, Booking Date */}
...
//                                         {/* Financial Details - Main Amounts */}
