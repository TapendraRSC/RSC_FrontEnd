...
//                 plotSize: booking.plotSize || 'N/A',
//                 price: booking.price || 'N/A',
//                 bookingAmount: booking.bookingAmount || '0',
//                 totalPlotAmount: booking.totalPlotAmount || '0',
//                 onlinePlotAmount: booking.onlinePlotAmount || '0',
//                 creditPointAmount: booking.creditPointAmount || '0',
...
const BookingComponent: React.FC = () => {
    ...
    // FIX: Transform bookings with ALL required fields for edit
    const transformBookingsForTable = useMemo((): any[] => {
        return (bookingList || []).map((booking: BookingData) => {
            const bookingDate = booking.bookingDate ? formatDate(booking.bookingDate) : 'N/A';
            ...
            return {
                ...
                // FIX: Project fields - include projectId
                projectId: booking.projectId || null,
                projectName: booking.projectName || 'N/A',
                projectTitle: booking.projectName || 'N/A',

                // FIX: Plot fields - include plotId
                plotId: booking.plotId || null,
                plotNumber: booking.plotNumber || 'N/A',
                plotSize: booking.plotSize || '',

                // FIX: Price fields - THIS IS THE MAIN FIX
                ...
                // Also keep the original field names
    ...
    // FIX: handleEdit - pass ALL required fields to BookingModal
    const handleEdit = (booking: any) => {
        ...
        const modalData = {
            ...
            // Project and Plot (for title matching if IDs not available)
            projectTitle: booking.projectTitle || booking.projectName || '',
            plotNumber: booking.plotNumber || '',
            plotSize: booking.plotSize || '',

            // FIX: Price fields - use correct field names
            price: booking.price || booking.totalPlotAmount || '',
            onlinePrice: booking.onlinePrice || booking.onlinePlotAmount || '',
            creditPoint: booking.creditPoint || booking.creditPointAmount || '',
